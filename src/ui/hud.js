export class HUD {
    ...
    render() {
        ...
        const toolName = this.app.tools?.currentTool?.name;
        const eraserSizes = { 9: 'small', 20: 'medium', 48: 'large' };
        const rightClickLabel = toolName === 'eraser'
            ? `eraser ${eraserSizes[currentWidth] || 'medium'}`
            : (currentWidth > 3 ? 'thin' : 'thick');
